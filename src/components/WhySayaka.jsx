        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-6">
              ...
              <span className="text-sm text-gray-500 italic">"La calidad es lo primero"</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {reasons.map((r, i) => (
              <motion.div
                ...
                className="group p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-[#3366FF]/20 transition-all duration-500"
              >
                <div className="w-12 h-12 rounded-xl bg-[#3366FF]/10 border border-[#3366FF]/20 flex items-center justify-center mb-4 group-hover:bg-[#3366FF]/20 transition-colors duration-300">
                  <r.icon size={22} className="text-[#3366FF]" />
                </div>
