  ...
  return (
    <section className="relative py-8 border-y border-white/5 bg-[#12121A]/80 backdrop-blur-sm overflow-hidden">
      <div className="w-full max-w-[1536px] mx-auto px-5 sm:px-8 md:px-12 xl:px-24">
        <p className="text-center text-xs text-gray-500 uppercase tracking-[0.2em] mb-5 sm:mb-6 font-medium">
          Compatible con las principales marcas del mercado
        </p>
      </div>
      <div className="relative">
        <div className="absolute left-0 top-0 bottom-0 w-12 sm:w-20 bg-gradient-to-r from-[#12121A] to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-12 sm:w-20 bg-gradient-to-l from-[#12121A] to-transparent z-10" />
        <motion.div
          animate={{ x: ['0%', '-50%'] }}
