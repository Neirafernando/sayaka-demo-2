...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-[100dvh] flex items-center overflow-hidden bg-[#0a0f18] pt-16 lg:pt-20">
      {/* Background image */}
      <div className="absolute inset-y-0 right-0 w-full lg:w-[65%] z-0">
        <img
          src="/real-hero.jpg"
          alt="Industrial blades"
          className="w-full h-full object-cover object-right opacity-30 lg:opacity-40 mix-blend-screen"
          loading="eager"
        />
        ...
        <div className="grid lg:grid-cols-12 gap-6 items-center py-10 sm:py-14 lg:py-20">
          ...
          <div className="lg:col-span-8 flex flex-col justify-center">
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-semibold text-[#6699FF] tracking-wide uppercase">Alta Ingeniería en Corte</span>
            </motion.div>
            ...
            >
              Fabricamos, importamos y exportamos repuestos para la industria del cartón corrugado, papel tisú, entre otros.
              <span className="text-white font-medium block mt-2 sm:mt-3">Rendimiento garantizado, impulsado por calidad superior.</span>
            </motion.p>
            ...
            >
              {[
                ...
                <div key={s.label}>
                  <div className="font-[Outfit] font-black text-2xl sm:text-3xl text-white">{s.value}</div>
                  <div className="text-[10px] sm:text-xs text-gray-500 mt-1 uppercase tracking-wider font-semibold leading-tight">{s.label}</div>
                </div>
              ))}
            </motion.div>
          </div>
