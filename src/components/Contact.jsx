      ...
      <div className="relative w-full max-w-[1536px] mx-auto px-6 md:px-12 xl:px-24">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <motion.form
            ...
            transition={{ duration: 0.8 }}
            className="lg:col-span-3 space-y-5 p-8 rounded-2xl bg-white/[0.03] border border-white/[0.06]"
          >
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white placeholder-gray-600 focus:border-[#3366FF]/50 focus:outline-none focus:ring-1 focus:ring-[#3366FF]/30 transition-all"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white placeholder-gray-600 focus:border-[#3366FF]/50 focus:outline-none focus:ring-1 focus:ring-[#3366FF]/30 transition-all resize-none"
                placeholder="Describa los repuestos que necesita, medidas, cantidad..."
              />
            </div>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-[#3366FF] to-[#4455FF] rounded-xl text-white font-bold hover:shadow-[0_0_40px_rgba(51,102,255,0.3)] transition-all duration-500"
            >
              <Send size={18} />
              Enviar por WhatsApp
            </button>
          ...
          >
            {[
              ...
              <div key={item.label} className="flex gap-4 p-5 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-[#3366FF]/20 transition-all duration-300">
                <div className="w-11 h-11 rounded-xl bg-[#3366FF]/10 border border-[#3366FF]/20 flex items-center justify-center shrink-0">
                  <item.icon size={20} className="text-[#3366FF]" />
                </div>
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wider font-medium">{item.label}</p>
                  {item.href ? (
                    <a href={item.href} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#3366FF] transition-colors mt-0.5 block">
                      {item.value}
                    </a>
                  ) : (
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full px-6 py-4 rounded-2xl bg-[#25D366] text-white font-bold hover:bg-[#22c55e] transition-all duration-300 shadow-[0_0_20px_rgba(37,211,102,0.2)] hover:shadow-[0_0_30px_rgba(37,211,102,0.4)]"
            >
